...
日期：2026-09-11
状态：已实施（ClockStage 双源逐行歌词与偏好记忆已落地；2026-09-20 又加入 CompactPlayer 单行歌词，2026-09-22 加入舞台点击切换与歌词、频谱共显）。下文保留 2026-09-11 原设计范围；其后扩展单独标注。
...
- 简洁模式（CompactPlayer）内的单行歌词不属于本期；已于 2026-09-20 另行实施。
